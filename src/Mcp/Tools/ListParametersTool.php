...
#[IsReadOnly]
class ListParametersTool extends Tool
{
    protected string $description = 'List all reusable parameters within a Swagger/OpenAPI file';
    ...
    public function handle(Request $request) : Response|ResponseFactory
    {
        ...
        return Response::structured($file->json('components.parameters'));
    }
