...
#[IsReadOnly]
class ListRequestBodiesTool extends Tool
{
    protected string $description = 'List all reusable request body definitions within a Swagger/OpenAPI file';
    ...
    public function handle(Request $request) : Response|ResponseFactory
    {
        ...
        return Response::structured(['requestBodies' => $file->collect('components.requestBodies')->keys()->all()]);
    }
